export const BIRDDOG_NFT_NAME = 'BirdDogNFT';
export const BIRDDOG_NFT_SYMBOL = 'BDOG';
export const IPFS_HASH = 'QmR1eRsCqpMsHq9KaGHBGRw4YWjhj9kCwyeozCoH7am2Vb';
...
export const BROKENBYTE_ENGINEERING_DEPLOYER = '0x566bD9Df983BfEFf836A2C3b644553e6A80850Fa'; // BrokenByte Engineering Deployer;;
